...
urlpatterns = [
    ...
    url(r'^Predict_Escalation_Attack_Detection/$', remoteuser.Predict_Escalation_Attack_Detection, name="Predict_Escalation_Attack_Detection"),
    ...
    url(r'^View_Predicted_Escalation_Attack_Detection_Ratio/$', serviceprovider.View_Predicted_Escalation_Attack_Detection_Ratio, name="View_Predicted_Escalation_Attack_Detection_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Escalation_Attack_Detection_Details/$', serviceprovider.View_Predicted_Escalation_Attack_Detection_Details, name="View_Predicted_Escalation_Attack_Detection_Details"),
